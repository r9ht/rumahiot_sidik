...
RUMAHIOT_FORGOT_PASSWORD_TABLE = os.environ.get('RUMAHIOT_FORGOT_PASSWORD_TABLE', '')
...
RUMAHIOT_SURAT_SEND_FORGOT_PASSWORD_EMAIL_ENDPOINT = os.environ.get('RUMAHIOT_SURAT_SEND_FORGOT_PASSWORD_EMAIL_ENDPOINT', '')
